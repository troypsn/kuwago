...
class OnboardingDetectionFragment : Fragment() {
 ...
 override fun onViewCreated(v:View,s:Bundle?){v.findViewById<View>(R.id.btn_detection_continue).setOnClickListener{(activity as? OnboardingHost)?.navigateToNextPage()}}
}
